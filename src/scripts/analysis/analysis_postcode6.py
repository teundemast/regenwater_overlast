...
resultFile = open (resultFolder +"result_postcode6_all.txt", "w+") 
...
for path in ["postcode6_number1.pkl", "postcode6_number2.pkl", "postcode6_number3.pkl", "postcode6_number4.pkl", "postcode6_number5.pkl"]:
