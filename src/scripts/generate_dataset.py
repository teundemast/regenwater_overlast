...
for i in [3,4,5]:
    ...
    input_file = "merged_precise_coord_transformed.json"
    output_file = f'pkls/precise{i}.pkl'
...
for i in [3,4,5]:
    dir_ = '/local/s2656566/wateroverlast/regenwater_overlast/src/data/'
    input_file = f"postcode4/postcode4_number{i}.json"
    output_file = f'pkls/postcode4/postcode4_number{i}.pkl'
...
for i in [3,4,5]:
    dir_ = '/local/s2656566/wateroverlast/regenwater_overlast/src/data/'
    input_file = f"postcode6/postcode6_number{i}.json"
    output_file = f'pkls/postcode6/postcode6_number{i}.pkl'
